 ...
 *Clase para implementar los servicios del módulo de accesos
 */
public class AccesoService {
	 ...
	 * @param clienteAccede identificador del cliente que realizó el acceso
	...
	/**
	 * Método para obtener los accesos en un rango de fechas
